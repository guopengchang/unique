<template>
  ...
  <view class="content" :style="{ marginTop: ` ${top}px` }">
    <uni-card title="用户管理" class="card_box">
      <view
        class="card"
...
import signIn from "@/static/management-pic/register.png";
import clue from "@/static/management-pic/clue.png";
...
import clueItem from "@/static/management-pic/clueItem.png";
import remind from "@/static/management-pic/remind.png";
...
// 猜你喜欢的列表
const getuserlist=ref<any>([
  {
    path: "/pages/getCustomer/signIn",
    icon: signIn,
    name: "签到",
  },
  {
    path: "/pages/getCustomer/clue/item",
    icon: clueItem,
    name: "新增",
  },
])
const getCustomerList = ref<any[]>([
  ...
  {
    path: "/pages/getCustomer/remind/remind",
    icon: remind,
    name: "跟进提醒",
  },
